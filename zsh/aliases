...
# Work around the Debian package conflict with bat/batcat
...
# Newer implementation and gl and gp
# _git_with_upstream() {
#   if git rev-parse --abbrev-ref --symbolic-full-name @{u} &>/dev/null; then
#     git "$@"
#   else
#     git "$@" origin "$(git_current_branch)"
#   fi
# }
#
# gp() { _git_with_upstream push -u }
# gl() { _git_with_upstream pull }

# Rarely used aliases, pending future deletion
# alias g='git'
# alias ga='git add'
# alias gb='git branch'
# alias gc='git commit'
